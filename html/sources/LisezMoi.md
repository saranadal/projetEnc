...
Puis, pour le menu déroulant, je me suis permise d'appliquer un script, afin d'obtenir un menu qui apparaît et disparaît selon les besoins du visiteur. N'ayant jamasi fait de javaScript, je suis allée chercher le scritp sur internet (Cf. Sources en ligne).
...
Après, c'est la redimension des vidéos qui posait problème. Je souhaitais que les vidéos apparaissent en grand, avec un titre placé en dessous.
